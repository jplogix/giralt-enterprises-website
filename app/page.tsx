...
export default function HomePage() {
	const products: Array<{
	...
	}> = [
		{
			title: "Handrails",
			description:
				"Weld-free aluminum picket handrail system. DOT approved in 6 states.",
		...
		},
		{
			...
			description:
				"Elite and standard fixed and floating dock systems with aluminum 6061-T6 construction.",
		...
		},
		{
			title: "Seawalls",
			description:
				"Aluminum, Vinyl and FRP seawall materials with full engineering support.",
		...
		},
		{
			...
			description:
				"Quick-install aluminum bridges with spans up to 100 feet. Five models available.",
		...
		},
		{
			...
			description:
				"Multiple configurations to break up wave energy and boat wake.",
				...
				<div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
					<div className="max-w-4xl">
						...
						<h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
							...
							<br />
							for &ldquo;Difficult&rdquo; Projects
						</h1>
						<p className="text-xl md:text-2xl mb-8 text-primary-foreground/90 text-pretty leading-relaxed">
							...
							distribution for quality Civil Engineering construction products.
							We thrive on those "difficult" projects, where product knowledge
							and applications expertise become indispensable.
						</p>
				...
				<div className="container mx-auto px-4 relative z-10">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-xl text-muted-foreground mb-8">
							Our innovative weld-free handrail system earned the Florida
							Engineering Society's 2006 Governor's New Product Award and the
							National Society of Professional Engineers' 2007 New Product
							Award.
						</p>
			...
			<section className="py-20 bg-linear-to-r from-[oklch(0.15_0.12_253)] to-[oklch(0.18_0.12_253)] text-primary-foreground relative overflow-hidden">
				...
				<div className="container mx-auto px-4 text-center relative z-10">
					...
					<p className="text-xl mb-8 max-w-2xl mx-auto text-primary-foreground/90">
						Contact us today and we'll show you how our 35+ years of experience
