	...
	const awards = [
		{
			...
			organization:
				"Florida Engineering Society / Florida Petroleum Equipment Institute",
			description:
				"Recognized for innovation in engineering product development",
		...
		},
		{
			...
			description:
				"National recognition for groundbreaking handrail system design",
				...
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-xl text-primary-foreground/90 leading-relaxed">
							Our innovative weld-free handrail system has earned prestigious
							recognition from both state and national engineering societies
						</p>
					</div>
				</div>
			</section>
								...
								<div className="flex items-start gap-4 mb-6">
									...
									<div>
										...
										<p className="text-lg text-muted-foreground leading-relaxed">
											In 2002, we invented a system of picket handrails that
											requires no welding of the pickets. This revolutionary
											approach simplified installation while maintaining
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
						{awards.map((award, index) => (
							<Card
								...
								className="border-2 hover:shadow-xl transition-shadow overflow-hidden"
							>
