...
export default function BridgesPage() {
  ...
  const models = [
    ...
    { name: 'Colonial', description: 'Traditional styling with contemporary strength' },
    { name: 'Contour', description: 'Sleek, modern profile for urban environments' },
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-primary-foreground/90 leading-relaxed">
              Aluminum pedestrian bridges can provide a quick, economical, and aesthetic solution to your pedestrian bridge requirements.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center">Why Choose Aluminum Bridges?</h2>
              ...
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Can be delivered fully assembled and installed in a matter of hours
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Single unsupported spans up to 90-100 feet depending on width and load
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Aesthetic Design</h3>
                  <p className="text-sm text-muted-foreground">
                    Multiple models to complement any environment or architecture
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="bg-secondary/30 border-2">
              <CardContent className="pt-6">
                <h3 className="text-xl font-semibold mb-4">Installation Advantages</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  In many cases, the bridges can be delivered fully assembled, and installed in a matter of hours. This minimizes disruption to your site and accelerates project completion.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Depending on width and load requirements, single unsupported spans can be as large as <strong>90 to 100 feet</strong>, reducing or eliminating the need for intermediate supports.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center">Available Bridge Models</h2>
      ...
      <section className="py-20 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6">Custom Solutions Available</h2>
            <p className="text-xl text-muted-foreground mb-8">
              Every project has unique requirements. We work with you to select the right model, span, width, and load capacity for your specific needs.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                <CardContent className="pt-6">
                  <h3 className="font-semibold mb-2">Custom Widths</h3>
                  <p className="text-sm text-muted-foreground">Tailored to your traffic requirements</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
                  <h3 className="font-semibold mb-2">Load Ratings</h3>
                  <p className="text-sm text-muted-foreground">Engineered for your specific load needs</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
                  <h3 className="font-semibold mb-2">Span Lengths</h3>
                  <p className="text-sm text-muted-foreground">Up to 100 feet for most configurations</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-accent text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Build Your Bridge?</h2>
