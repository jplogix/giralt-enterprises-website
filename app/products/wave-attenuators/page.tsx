...
export const metadata: Metadata = {
	...
	description:
		"Energy dissipating systems for wind-generated waves and boat wakes. Custom solutions for marina protection and shoreline stabilization.",
};
				...
				<div className="container mx-auto px-4">
					<div className="max-w-4xl">
						...
						<p className="text-xl text-primary-foreground/90 leading-relaxed">
							Wave attenuators are used to break up the energy of wind-generated
							waves, and/or the wake of passing boats.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="py-20">
				<div className="container mx-auto px-4">
					...
					<div className="max-w-4xl mx-auto">
						<ProductGalleryClient category="attenuators" />
					</div>
				</div>
			</section>
			...
			<section className="py-20 bg-secondary/30">
				<div className="container mx-auto px-4">
					...
					<p className="text-xl text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
						There are several physical configurations that can be used, each
							...
							>
								<CardContent className="pt-6">
									<div className="flex justify-between items-start mb-3">
										...
										<Badge
											variant={
												config.badge === "Premium" ? "default" : "outline"
											}
										>
											{config.badge}
										</Badge>
								...
								<div className="space-y-6">
									<div>
										...
										<p className="text-muted-foreground">
											Typically, the <strong>vertical slats</strong> are the
											least effective configuration for wave energy dissipation.
										</p>
									</div>
									<div>
										<h3 className="text-lg font-semibold mb-2">
										...
										<p className="text-muted-foreground">
											The <strong>shadowbox design</strong> is the most
											effective configuration for breaking up wave energy.
										</p>
									</div>
									<div>
										<h3 className="text-lg font-semibold mb-2">
										...
										<p className="text-muted-foreground">
											<strong>Angled slats</strong> have proven to be effective,
											but the clear spacing used is critical to proper
											performance. <strong>Horizontal beams</strong> can be
							...
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-muted-foreground leading-relaxed mb-4">
										Wave attenuators add a tremendous amount of load to the
										piles. This can be a problem when installing a wave
										attenuator in an existing facility, because the piles may
										not have the required strength to support the additional
										load.
									</p>
									<p className="text-muted-foreground leading-relaxed">
										Let us know what your needs are. We'll come up with a "best"
										solution, taking all factors into account.
									</p>
								</div>
							</div>
						</CardContent>
						...
						<Card>
							<CardContent className="pt-6">
								<p className="text-muted-foreground mb-6">
									For detailed technical information on the use of aluminum in
									wave attenuators, please contact us:
								</p>
			...
			<section className="py-20 bg-linear-to-r from-primary to-accent text-primary-foreground">
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
						We'll evaluate your site conditions and recommend the best wave
						attenuator solution
					</p>
