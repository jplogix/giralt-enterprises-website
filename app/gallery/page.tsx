...
export default function GalleryPage() {
  ...
  const gallery = [
    ...
    { category: 'gangways', title: 'Marina Gangway', image: '/images/giralt/pedestrian_bridges/long_key_natural_area.jpg' },
    { category: 'gangways', title: 'Aluminum Ramp', image: '/images/giralt/pedestrian_bridges/richardson_park_boardwalk.jpg' },
