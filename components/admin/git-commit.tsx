		...
		try {
			...
			if (!response.ok) {
				if (data.configured === false) {
					throw new Error(
						"GitHub integration is not configured. Changes are saved locally but not committed to git.",
					);
				}
					...
					<div className="space-y-4 py-4">
						...
						<div className="space-y-2">
							...
							<p className="text-xs text-muted-foreground">
								This will commit changes to the repository and trigger a Vercel
								deployment
							</p>
						</div>
					</div>
